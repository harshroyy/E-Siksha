      ...
      <section className="text-center">
        <div className="container px-4 mx-auto">
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-4xl text-gray-100 mb-4 font-thin">
                ...
                <div className="flex justify-center gap-8">
                  {slide.map((teacher, idx) => (
                    <motion.div
                      ...
                      className="bg-white rounded-3xl p-6 text-center shadow-md w-72 hover:shadow-lg transition-all duration-300 border border-[#282834]"
                    >
                      <div className="relative mb-6">
                        <div className="w-36 h-36 mx-auto">
                          <img
                            src={teacher.photo}
                            alt={teacher.name}
                            className="w-full h-full rounded-full object-cover border-4 border-[#282834]"
                          />
                        </div>
                        <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                          <span className="bg-[#282834] text-white px-4 py-1 rounded-full text-sm font-medium shadow-md">
                            {teacher.subject}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-center space-x-4">
                        <button className="text-[#282834] hover:text-[#1c1c24] transition-colors text-lg">
